            ...
            <div class="card-header bg-primary text-white text-center">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="<?php echo $baris['nama']; ?>" type="text" class="form-control" id="Nama" name="Nama" required>
                        <input name="no" value="<?php echo $no; ?>" hidden>
                    </div>
                    <div class="mb-3">
                        <label for="Nim" class="form-label">Masukkan Nim</label>
                        <input value="<?php echo $baris['nim']; ?>" type="text" class="form-control" id="Nim" name="Nim" required>
                    </div>
                    <div class="mb-3">
                        <label for="Kelas" class="form-label">Pilih Kelas</label>
                        <select class="form-select" id="Kelas" name="Kelas" required>
                            <option value="" disabled selected>-- Pilih Kembali Kelas --</option>
